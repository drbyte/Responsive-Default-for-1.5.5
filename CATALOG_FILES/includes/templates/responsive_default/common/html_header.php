...
// ZCA Responsive Components (BOF-add 1 of 2)
...
// ZCA Responsive Components (EOF-add 1 of 2)
?>
...
// ZCA Responsive Components (BOF-add 2 of 2)
...
if ( $detect->isMobile() && !$detect->isTablet() && $_SESSION['layoutType'] == 'full' || $detect->isTablet() && $_SESSION['layoutType'] == 'full' ){
    echo '';
