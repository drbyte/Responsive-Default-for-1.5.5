...
// ZCAdditions.com, ZCA Responsive Components (BOF-edit 1 of 1)
// $list_box_contents[$row][$col] = array('params' => 'class="centerBoxContentsAlsoPurch"' . ' ' . 'style="width:' . $col_width . '%;"',

    $list_box_contents[$row][$col] = array('params' => 'class="centerBoxContentsAlsoPurch centeredContent columns' . SHOW_PRODUCT_INFO_COLUMNS_ALSO_PURCHASED_PRODUCTS . '"',
// ZCAdditions.com, ZCA Responsive Components (EOF-edit 1 of 1)
