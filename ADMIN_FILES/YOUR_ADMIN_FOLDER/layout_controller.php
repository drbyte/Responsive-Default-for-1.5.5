...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
      ...
      $db->Execute("insert into " . TABLE_LAYOUT_BOXES . "
                  (layout_template, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single, layout_box_status_desktop, layout_box_status_tablet, show_box_min_width)
                  values ('" . zen_db_input($template_dir) . "', '" . zen_db_input($file) . "', 0, 0, 0, 0, 0, 0, 0, 0)");
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
        $layout_box_status_desktop = zen_db_prepare_input($_POST['layout_box_status_desktop']);
...
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
        $db->Execute("insert into " . TABLE_LAYOUT_BOXES . "
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
                    (layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single, layout_box_status_desktop, layout_box_status_tablet, show_box_min_width)
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
                            '" . zen_db_input($layout_box_status_desktop) . "',
                            '" . zen_db_input($layout_box_status_tablet) . "',
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
        ...
        $db->Execute("update " . TABLE_LAYOUT_BOXES . " set layout_box_status = '" . zen_db_input($layout_box_status) . "', layout_box_location = '" . zen_db_input($layout_box_location) . "', layout_box_sort_order = '" . zen_db_input($layout_box_sort_order) . "', layout_box_sort_order_single = '" . zen_db_input($layout_box_sort_order_single) . "', layout_box_status_desktop = '" . zen_db_input($layout_box_status_desktop) . "', layout_box_status_tablet = '" . zen_db_input($layout_box_status_tablet) . "', show_box_min_width = '" . zen_db_input($show_box_min_width) . "', layout_box_status_single = '" . zen_db_input($layout_box_status_single) . "' where layout_id = '" . zen_db_input($box_id) . "'");
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
...
<?php // (BOF - EDIT) ZCA Responsive Components for 1.5.5 ?>
                <td class="dataTableHeadingContent" align="center"><font color="#008cba"><?php echo 'Desktop Status'; ?></font></td>

                <td class="dataTableHeadingContent" align="center"><font color="#008cba"><?php echo 'Tablet Status'; ?></font></td>

                <td class="dataTableHeadingContent" align="center"><font color="#008cba"><?php echo 'Mobile Status'; ?></font></td>
<?php // (EOF - EDIT) ZCA Responsive Components for 1.5.5 ?>
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
  $column_controller = $db->Execute("select layout_id, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single, layout_box_status_desktop, layout_box_status_tablet, show_box_min_width from " . TABLE_LAYOUT_BOXES . " where (layout_template='" . zen_db_input($template_dir) . "' and layout_box_name NOT LIKE '%ezpages_bar%') order by  layout_box_location, layout_box_sort_order");
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
...
<?php // (BOF - EDIT) ZCA Responsive Components for 1.5.5 ?>
                <td class="<?php echo ( (file_exists($boxes_directory . $column_controller->fields['layout_box_name']) or file_exists($boxes_directory_template . $column_controller->fields['layout_box_name'])) ? dataTableContent : messageStackError ); ?>" align="center"><?php echo ($column_controller->fields['layout_box_status_desktop']=='1' ? TEXT_ON : '<span class="alert">' . TEXT_OFF . '</span>'); ?></td>
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
    switch ($bInfo->layout_box_status_desktop) {
      case '0': $layout_box_status_desktop_on = false; $layout_box_status_desktop_off = true; break;
      case '1':
      default: $layout_box_status_desktop_on = true; $layout_box_status_desktop_off = false;
    }

    switch ($bInfo->layout_box_status_tablet) {
      case '0': $layout_box_status_tablet_on = false; $layout_box_status_tablet_off = true; break;
      case '1':
      default: $layout_box_status_tablet_on = true; $layout_box_status_tablet_off = false;
    }
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
      $contents[] = array('text' => '<br /><font color="#008cba">' . 'Desktop Status' . '</font><br />' . zen_draw_input_field('layout_box_status_desktop'));

      $contents[] = array('text' => '<br /><font color="#008cba">' . 'Tablet Status' . '</font><br />' . zen_draw_input_field('layout_box_status_tablet'));

      $contents[] = array('text' => '<br /><font color="#008cba">' . 'Mobile Status' . '</font><br />' . zen_draw_input_field('show_box_min_width'));
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
      switch ($bInfo->layout_box_status_desktop) {
        case '0': $in_status_desktop = false; $out_status_desktop = true; break;
        case '1': $in_status_desktop = true; $out_status_desktop = false; break;
        default: $in_status_desktop = true; $out_status_desktop = false;
      }

      switch ($bInfo->layout_box_status_tablet) {
        case '0': $in_status_tablet = false; $out_status_tablet = true; break;
        case '1': $in_status_tablet = true; $out_status_tablet = false; break;
        default: $in_status_tablet = true; $out_status_tablet = false;
      }

      switch ($bInfo->show_box_min_width) {
        case '0': $in_status_mobile = false; $out_status_mobile = true; break;
        case '1': $in_status_mobile = true; $out_status_mobile = false; break;
        default: $in_status_mobile = true; $out_status_mobile = false;
      }
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
      $contents[] = array('text' => '<br />' . 'Desktop Status - Uses CSS to Hide Box @ 768px' . '<br />' . zen_draw_radio_field('layout_box_status_desktop', '1', $in_status_desktop) . TEXT_ON . zen_draw_radio_field('layout_box_status_desktop', '0', $out_status_desktop) . TEXT_OFF);

      $contents[] = array('text' => '<br />' . 'Tablet Status - Uses PHP to never even load Box on Tablet Devices' . '<br />' . zen_draw_radio_field('layout_box_status_tablet', '1', $in_status_tablet) . TEXT_ON . zen_draw_radio_field('layout_box_status_tablet', '0', $out_status_tablet) . TEXT_OFF);

      $contents[] = array('text' => '<br />' . 'Mobile Status - Uses PHP to never even load Box on Mobile Devices' . '<br />' . zen_draw_radio_field('show_box_min_width', '1', $in_status_mobile) . TEXT_ON . zen_draw_radio_field('show_box_min_width', '0', $out_status_mobile) . TEXT_OFF);
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
...
// (BOF - EDIT) ZCA Responsive Components for 1.5.5
        $contents[] = array('text' => 'Desktop Status' . ' ' . $bInfo->layout_box_status_desktop);

        $contents[] = array('text' => 'Tablet Status' . ' ' . $bInfo->layout_box_status_tablet);

        $contents[] = array('text' => 'Mobile Status' . ' ' . $bInfo->show_box_min_width);
// (EOF - EDIT) ZCA Responsive Components for 1.5.5
